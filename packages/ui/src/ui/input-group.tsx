...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: We use div as a semantic element
		<div
			role="group"
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: Div is used for click events
		// biome-ignore lint/a11y/useSemanticElements: Div is used as a semantic element
		<div
			role="group"
